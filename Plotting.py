...
Plot2D("Ox", "Oy", F_tri_Arr, "TriangularLattice_FreeEnergy.jpg")
Plot2D("Ox", "Oy", F_squ_Arr, "SquareLattice_FreeEnergy.jpg")
...
for j, J in enumerate(J_dom):
    freq_min_arr.append(np.min(w1_squ_arr[j, :, T0_index]))
print(len(freq_min_arr))
Plot1D("J", r"Minimum Phonon Frequency", [freq_min_arr], [], "SquareLattice_MinimumFrequencies.jpg")
