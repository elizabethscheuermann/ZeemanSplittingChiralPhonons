...
# Lattices
tri_data_filepath = "Data Runs/" + folder_path + "/TriangularLattice_Data.csv"
squ_data_filepath = "Data Runs/" + folder_path + "/SquareLattice_Data.csv"
cub_data_filepath = "Data Runs/" + folder_path + "/CubicLattice_Data.csv"
